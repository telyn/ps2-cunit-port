...
void test_snprintf_string_len_exact() {
...
void test_snprintf_string_len_small() {
	char *format = "hello %5s world";
	char beautiful[] = "beautiful";
	char dst[20] = { '\0' };
	int res = _ps2_cunit_snprintf(dst, 22, format, beautiful);
	CU_ASSERT_STRING_EQUAL(dst, "hello beaut world");
	CU_ASSERT_EQUAL(res, 18);
}

void test_snprintf_string_len_large() {
...
void test_snprintf_string_len_large_minus() {
	char *format = "hello %-5s world";
	char beautiful[] = "beautiful";
	char dst[20] = { '\0' };
	int res = _ps2_cunit_snprintf(dst, 22, format, beautiful);
...
void ps2snpftest_add_string_tests(CU_pSuite snprintf_suite) {
	...
	CU_ADD_TEST(snprintf_suite, test_snprintf_string_len_small);
	CU_ADD_TEST(snprintf_suite, test_snprintf_string_len_exact);
	CU_ADD_TEST(snprintf_suite, test_snprintf_string_len_large);
	CU_ADD_TEST(snprintf_suite, test_snprintf_string_len_large_minus);
}
